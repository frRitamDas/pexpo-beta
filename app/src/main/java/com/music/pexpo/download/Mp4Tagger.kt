...
import com.music.pexpo.data.lyrics.WORD_LYRICS_FIELD
...
object Mp4Tagger {
     ...
     * file — see [EmbeddedLyrics][com.music.pexpo.data.lyrics.EmbeddedLyrics],
    ...
    private const val MEAN = "com.music.pexpo"
