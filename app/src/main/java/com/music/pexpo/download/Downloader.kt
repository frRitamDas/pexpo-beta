package com.music.pexpo.download
 ...
 *    the same finding [ChunkedDataSource][com.music.pexpo.playback.ChunkedDataSource]
 *    exists for.
...
object Downloader {
     ...
     *    URL — see [SourceStream.headers][com.music.pexpo.data.sources.SourceStream.headers]
