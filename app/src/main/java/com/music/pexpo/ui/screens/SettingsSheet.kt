...
import com.music.pexpo.ui.components.languageDisplayNameRes
...
import com.music.pexpo.ui.performance.supportedPerformanceRefreshRates
...
import com.music.pexpo.playback.AudioOutputStatus
import com.music.pexpo.data.settings.AutomixPerformanceMode
import com.music.pexpo.R
import com.music.pexpo.data.sources.DeviceCodecs
...
import com.music.pexpo.data.stats.Backup
import com.music.pexpo.playback.AudioCache
import com.music.pexpo.ui.player.fullBleedArtworkAvailable
...
fun SettingsScreen(
    ...
    Column(
        ...
        SettingsGroup(header = stringResource(R.string.audio_quality)) {
            ...
            // one with a reason under it is the difference between "Pexpo
