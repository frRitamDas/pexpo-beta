 ...
 *
 * The queue holds `pexpo://watch?v=…` URIs that
...
object QualityUpgrade {
     ...
     *   [PlaybackService.audioFormatFor][com.music.pexpo.playback.PlaybackService].
     ...
     * [PlaybackService.upgradeQualityNow][com.music.pexpo.playback.PlaybackService].
     *
