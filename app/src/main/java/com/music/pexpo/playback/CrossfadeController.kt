...
import com.music.pexpo.data.settings.SmartAnalysis
import com.music.pexpo.data.settings.TrackAnalysisState
import com.music.pexpo.data.settings.TransitionWindow
import com.music.pexpo.playback.smart.CrossfadeMode
import com.music.pexpo.playback.smart.TrackAnalysis
import com.music.pexpo.playback.smart.TransitionStyle
import com.music.pexpo.playback.smart.TransitionTrackInfo
import com.music.pexpo.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.music.pexpo.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.music.pexpo.playback.smart.TransitionPlan],
     ...
     * ([com.music.pexpo.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.music.pexpo.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.music.pexpo.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.music.pexpo.playback.smart.TrackAnalyzer.request] as the next
    ...
    /** Pexpo doesn't carry album metadata on [MediaMetadata] yet, so [TransitionTrackInfo.album] stays blank. */
