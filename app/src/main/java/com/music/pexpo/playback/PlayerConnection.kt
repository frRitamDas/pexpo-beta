...
import com.music.pexpo.ui.rememberIsForeground
 ...
 */
private const val EXTRA_FROM_AUTOPLAY = "pexpo.fromAutoplay"

/** @see Song.radioName */
private const val EXTRA_RADIO_NAME = "pexpo.radioName"
 ...
 */
private const val EXTRA_ARTIST_ID = "pexpo.artistId"
private const val EXTRA_ALBUM_ID = "pexpo.albumId"

/** @see Song.setVideoId */
private const val EXTRA_SET_VIDEO_ID = "pexpo.setVideoId"

/** @see Song.localUri */
private const val EXTRA_LOCAL_URI = "pexpo.localUri"

/** @see Song.localPath */
private const val EXTRA_LOCAL_PATH = "pexpo.localPath"
 ...
 */
private const val EXTRA_DURATION = "pexpo.durationText"
private const val EXTRA_EXPLICIT = "pexpo.explicit"
private const val EXTRA_IS_VIDEO = "pexpo.isVideo"
private const val EXTRA_VIDEO_ORIGIN = "pexpo.isVideoOrigin"

/** Set only on the replacement item produced by [QualityUpgrade]. */
const val EXTRA_QUALITY_UPGRADED = "pexpo.qualityUpgraded"
 ...
 * terms [com.music.pexpo.data.sources.TrackMatcher] compares recordings on.
 *
...
fun Song.toMediaItem(): MediaItem {
    ...
    val uriString = offlineUri ?: when {
        ...
        // reach.
        else -> "pexpo://watch?v=$videoId${matchQuery()}"
    }
...
private fun Song.directYouTubeUri(): String =
    "pexpo://watch?v=$videoId${matchQuery()}&$DIRECT_YOUTUBE_PARAMETER=1&q=original"
 ...
 * — see [com.music.pexpo.data.TrackLog.about].
 *
