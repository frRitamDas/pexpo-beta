package com.music.pexpo.playback.smart
 ...
 * [com.music.pexpo.playback.AudioCache], because that is where *streamed*
 * audio lands. A track playing off the device never goes there:
 * [com.music.pexpo.playback.AudioCache.playbackFactory] routes `file://` and
 ...
 * [com.music.pexpo.playback.AudioCache.requestAnalysisHead] — the fallback
...
internal object LocalAudioSource {
    ...
    private const val TAG = "PexpoLocalAudio"
