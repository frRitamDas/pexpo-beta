 ...
 * connecting one means starting [PlaybackService][com.music.pexpo.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.music.pexpo.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("pexpo_widget", Context.MODE_PRIVATE)
