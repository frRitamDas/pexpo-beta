package com.music.pexpo.widget
...
import com.music.pexpo.playback.PlaybackService
 ...
 * from [rememberMediaController][com.music.pexpo.playback.rememberMediaController].
 *
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.music.pexpo.widget.TOGGLE"
        const val ACTION_NEXT = "com.music.pexpo.widget.NEXT"
        const val ACTION_PREVIOUS = "com.music.pexpo.widget.PREVIOUS"
