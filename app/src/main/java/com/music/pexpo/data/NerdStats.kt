...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.music.pexpo.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.music.pexpo.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.music.pexpo.playback.PlaybackService] — which the
     ...
     *
     * @see com.music.pexpo.playback.QualityUpgrade.forgetLastSession for the
