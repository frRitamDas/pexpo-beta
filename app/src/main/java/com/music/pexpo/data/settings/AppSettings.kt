package com.music.pexpo.data.settings
...
enum class AudioQuality(
     ...
     * [SourceConfig.enabled][com.music.pexpo.data.sources.SourceConfig.enabled],
 ...
 * Opus-in-WebM (see
 * [StreamResolver.resolveForDownload][com.music.pexpo.data.innertube.StreamResolver.resolveForDownload]),
...
object AppSettings {
    ...
    // [SourceResolver.requestForNow][com.music.pexpo.data.sources.SourceResolver.requestForNow],
     ...
     * decode per track.
     *
     * See [com.music.pexpo.playback.smart.TransitionPlanner].
     */
     ...
     * [ModuleSource.unplayable][com.music.pexpo.data.sources.ModuleSource],
     * which is where the refusal is applied.
     *
     * Independent of whether the device *can* decode it — that question is
     * [DeviceCodecs.playsDolbyAtmos][com.music.pexpo.data.sources.DeviceCodecs],
    ...
    /**
     * Widens stereo output via [com.music.pexpo.playback.SpatialAudioProcessor],
     ...
     * all. See [CanvasRepository][com.music.pexpo.data.canvas.CanvasRepository].
     */
     ...
     * — see [CanvasCache][com.music.pexpo.data.canvas.CanvasCache] for why
     ...
     * [NowPlayingScreen][com.music.pexpo.ui.player.NowPlayingScreen].
     */
     ...
     * that have not gone away — see [ArtworkMesh][com.music.pexpo.ui.player.ArtworkMesh]
     * for the colour one (a cover that is nine-tenths black with a red stripe
     * comes back from the quantiser as a red screen) and
     * [ArtworkMeshBackdrop][com.music.pexpo.ui.player.ArtworkMeshBackdrop]
    ...
    /**
     * The order [lyricsSources] are asked in — see [LyricsRepository][com.music.pexpo.data.lyrics.LyricsRepository]:
    ...
    /** Disk budget for cached audio. [AudioCache][com.music.pexpo.playback.AudioCache] evicts past it. */
     ...
     * [ArtistFacts][com.music.pexpo.data.stats.ArtistFacts]. On by default,
     ...
     * [PlaybackService][com.music.pexpo.playback.PlaybackService] can pick
     ...
     *
     * The one caller is an import ([Backup][com.music.pexpo.data.stats.Backup]),
     ...
     *
     * Pexpo ships sideloaded (see [com.music.pexpo.data.AppUpdateChecker]),
     ...
     *
     * [Downloads][com.music.pexpo.download.Downloads] keeps its record of
