 ...
 * [module][com.music.pexpo.data.sources.module] rather than inside it —
...
data class AddonManifest(
     ...
     * parameters on every request; Pexpo has no such form, so it sends the
     ...
     * [AddonSource][com.music.pexpo.data.sources.AddonSource] falls back to
 ...
 * [MusicSource][com.music.pexpo.data.sources.MusicSource] is asked for
 ...
 * [StreamContainer][com.music.pexpo.playback.StreamContainer] is told
...
data class AddonStream(
     ...
     * failure [StreamContainer][com.music.pexpo.playback.StreamContainer]
     * exists to describe.
     *
