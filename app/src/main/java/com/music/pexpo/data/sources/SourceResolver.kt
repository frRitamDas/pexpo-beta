package com.music.pexpo.data.sources
...
import com.music.pexpo.data.settings.AudioQuality
import com.music.pexpo.data.settings.DownloadQuality
...
object SourceResolver {
    ...
    /**
     * @param uri a `pexpo://source?...` URI as built by [SourceRegistry.trackUri].
     ...
     * [toMediaItem][com.music.pexpo.playback.toMediaItem].
     */
     ...
     * playback as `pexpo://watch?v=…` and never passes through [resolve].
     ...
     * [StreamChoice][com.music.pexpo.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.music.pexpo.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.music.pexpo.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.music.pexpo.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.music.pexpo.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.music.pexpo.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.music.pexpo.playback.QualityUpgrade]
     ...
     * [AudioCache][com.music.pexpo.playback.AudioCache] decide how to treat
     ...
     * [PlaybackService][com.music.pexpo.playback.PlaybackService]'s
