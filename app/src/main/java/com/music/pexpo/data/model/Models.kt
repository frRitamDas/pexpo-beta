package com.music.pexpo.data.model
...
data class Song(
    ...
    /** A premium rendition marker recorded by Pexpo for its Downloads list. */
     ...
     * that need it — see [com.music.pexpo.playback.toMediaItem].
     */
...
data class DetailPage(
     ...
     * added — see [com.music.pexpo.data.innertube.InnertubeParser.parsePlaylistShelf].
