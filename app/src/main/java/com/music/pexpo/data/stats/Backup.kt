package com.music.pexpo.data.stats
...
object Backup {
    ...
    fun suggestedName(): String =
        "pexpo-backup-${DateTimeFormatter.ofPattern("yyyy-MM-dd").format(
    ...
    suspend fun importFrom(context: Context, source: Uri): Result<Summary> = withContext(Dispatchers.IO) {
        runCatching {
            ...
            require(file.version <= SCHEMA_VERSION) {
                "That backup was written by a newer version of Pexpo"
            }
    ...
    private const val APP_TAG = "pexpo"
