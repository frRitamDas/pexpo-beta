 ...
 * [StreamResolver][com.music.pexpo.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.music.pexpo.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.music.pexpo.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.music.pexpo.data.settings.AppSettings] and is turned
