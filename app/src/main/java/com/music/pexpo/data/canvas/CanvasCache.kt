package com.music.pexpo.data.canvas
 ...
 * [CanvasArtworkPlayer][com.music.pexpo.ui.player.CanvasArtworkPlayer].
 *
...
object CanvasCache {
    ...
    /** Opened once per process, alongside [com.music.pexpo.playback.AudioCache.init]. */
     ...
     * choice [com.music.pexpo.playback.AudioCache] makes for audio.
     */
