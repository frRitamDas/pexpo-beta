package com.music.pexpo.data.lyrics
 ...
 * `com.music.pexpo.download.LyricsTag`), and LRC is what that field is read
 ...
 * atom, where every other player looks, and this to a Pexpo-specific one
 ...
 */
internal const val WORD_LYRICS_FIELD = "PEXPO_LYRICS"
