...
import com.music.pexpo.data.sources.addon.AddonClient
import com.music.pexpo.data.sources.addon.AddonException
import com.music.pexpo.data.sources.addon.DetectedFormat
import com.music.pexpo.data.sources.addon.SourceFormats
...
object SourceRegistry {
    ...
    fun init(context: Context) {
        prefs = runCatching {
            ...
            context.getSharedPreferences("pexpo_sources_plain", Context.MODE_PRIVATE)
        }
     ...
     * file is worth is [DownloadQuality][com.music.pexpo.data.settings.DownloadQuality]'s
     * question, and when it may be fetched is
     * [AppSettings.wifiOnlyDownloads][com.music.pexpo.data.settings.AppSettings.wifiOnlyDownloads]'s.
     */
     ...
     * see [SourcesScreen][com.music.pexpo.ui.screens.SourcesScreen].
     */
     ...
     *
     * Packed into the existing [Song.videoId][com.music.pexpo.data.model.Song.videoId]
