package com.music.pexpo.data.sources.module
 ...
 * [SourceRegistry][com.music.pexpo.data.sources.SourceRegistry] never
 ...
 *
 * Ported from Convx's `ModuleManager`, adapted to use Pexpo's shared
...
class ModuleManager {
     ...
     *
     * Concurrent because [ModuleSource.search][com.music.pexpo.data.sources.ModuleSource.search]
    ...
    private companion object {
         ...
         * [TrackMatcher][com.music.pexpo.data.sources.TrackMatcher] one —
         ...
         * trade [StreamChoice][com.music.pexpo.playback.StreamChoice] makes,
